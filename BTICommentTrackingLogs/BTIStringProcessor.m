...
- (NSString *)outputString
{
    ...
    for (NSString *line in originalLines)
    {
        ...
        [modifiedLines addObject:[self addCommentMarksToLine:line]];
    }
...
- (NSString *)addCommentMarksToLine:(NSString *)line
{
    NSString *dividingString = @"BTITrackingLog";
    if ([line rangeOfString:@"NSLog"].location != NSNotFound)
    {
        dividingString = @"NSLog";
    }
    
    NSArray *components = [line componentsSeparatedByString:dividingString];
    
    NSString *leftSide = [components objectAtIndex:0];
    NSString *rightSide = [line substringFromIndex:[leftSide length]];
    ...
    NSString *commentedLine = [NSString stringWithFormat:@"%@//%@", leftSide, rightSide];
